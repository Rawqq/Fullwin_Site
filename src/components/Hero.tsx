          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
              <div className="glass-panel-strong flex items-center gap-3 px-4 py-3">
                ...
                <span className="text-sm font-medium text-white">{t('hero.games')}</span>
              </div>
              <div className="glass-panel-strong flex items-center gap-3 px-4 py-3">
                <Gift className="h-5 w-5 text-secondary" />
                <span className="text-sm font-medium text-white">{t('hero.gifts')}</span>
              </div>
            </div>

            {/* CTA Buttons */}
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
              <a href="https://t.me/fullwin_official_bot" target="_blank" rel="noopener noreferrer" className="glass-button shimmer px-8 py-4 text-base">
                {t('hero.openFullwin')}
              </a>
              <a href="#how" className="glass-button-secondary px-8 py-4 text-base">
                {t('hero.howItWorks')}
              </a>
            </div>
          </div>
